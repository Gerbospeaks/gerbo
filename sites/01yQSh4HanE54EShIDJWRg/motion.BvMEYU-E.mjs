    ...
    (ee = Object.create),
      ...
      (ce = (e, t, n) =>
        t in e
          ...
          : (e[t] = n)),
      (le = (e, t) => te(e, `name`, { value: t, configurable: !0 })),
      (ue = (e, t) =>
        function () {
          return (
            t || (0, e[re(e)[0]])((t = { exports: {} }).exports, t), t.exports
          );
        }),
      (de = (e, t) => {
      ...
      (be = (e, t, n, r, i, a) => {
        ...
        return d || ve(e, i), v && te(i, n, v), p ? (d ^ 4 ? a : v) : i;
      }),
      ...
      (we = (e, t, n) => (
        Se(e, t, `read from private field`), n ? n.call(e) : t.get(e)
      )),
      (Te = (e, t, n) =>
        t.has(e)
          ...
          : t instanceof WeakSet
            ...
            : t.set(e, n)),
      (Ee = (e, t, n, r) => (
        Se(e, t, `write to private field`), r ? r.call(e, n) : t.set(e, n), n
      )),
...
function ze(e, t) {
  let n = !1,
    ...
    a = () => (n = !0),
    o = Ps.reduce((e, n) => ((e[n] = Re(a, t ? n : void 0)), e), {}),
    {
      setup: s,
      read: c,
      resolveKeyframes: l,
    ...
    h = () => {
      ...
      (n = !1),
        N.useManualTiming ||
          (i.delta = r ? 1e3 / 60 : Math.max(Math.min(a - i.timestamp, Fs), 1)),
        (i.timestamp = a),
        (i.isProcessing = !0),
        s.process(i),
        c.process(i),
  ...
  return { schedule: _, cancel: v, state: i, steps: o };
}
function Be() {
  Ls = void 0;
}
...
function Ue(e) {
  ...
  return (
    isNaN(e) &&
    typeof e == `string` &&
    ((t = e.match(Js))?.length || 0) + ((n = e.match(sc))?.length || 0) > 0
  );
}
function We(e) {
  let t = e.toString(),
    ...
    o = t.replace(
      ...
      (e) => (
        G.test(e)
          ? (r.color.push(a), i.push(lc), n.push(G.parse(e)))
          : e.startsWith(dc)
...
function nt(e, t) {
  let n = { ...e, ...t },
    r = {};
  for (let i in n)
    e[i] !== void 0 && t[i] !== void 0 && (r[i] = et(e[i])(e[i], t[i]));
  return (e) => {
...
function at(e) {
  let t = 0,
    n = e.next(t);
  for (; !n.done && t < Sc; ) (t += 50), (n = e.next(t));
  return t >= Sc ? 1 / 0 : t;
}
...
function ct({
  ...
  let i, a;
  os(e <= F(J.maxDuration), `Spring duration must be 10 seconds or less`);
  let o = 1 - t;
...
function pt(e = J.visualDuration, t = J.bounce) {
  ...
  let b = {
    ...
    toString: () => {
      let e = Math.min(at(b), Sc),
        t = xc((t) => b.next(e * t).value, e, 30);
      return e + `ms ` + t;
    },
    toTransition: () => {},
  };
...
function gt(e, t, { clamp: n = !0, ease: r, mixer: i } = {}) {
  let a = e.length;
  if (
    (M(a === t.length, `Both input and output ranges must be the same length`),
    a === 1)
  )
    return () => t[0];
...
function xt({
  ...
  let i = ks(r) ? r.map(Ns) : Ns(r),
    a = { done: !1, value: t[0] },
    o = yt(n && n.length === t.length ? n : vt(t), e),
    s = gt(o, t, { ease: Array.isArray(i) ? i : bt(t, i) });
  return {
...
function It(
  ...
  c && (u.offset = c);
  let d = Ft(s, i);
  Array.isArray(d) && (u.easing = d), L.value && Rs.waapi++;
  let f = {
    delay: r,
    duration: i,
...
function Ht(e) {
  ...
  if (!Vt((t = n?.owner)?.current)) return !1;
  let { onUpdate: c, transformTemplate: l } = n.owner.getProps();
  return (
    dl() &&
    r &&
    ul.has(r) &&
...
function Yt(e, t) {
  let n = jl(e);
  return (
    n !== kl && (n = K), n.getAnimatableNone ? n.getAnimatableNone(t) : void 0
  );
}
function Xt(e) {
  return typeof e == `number`
...
function Zt(e, t, n) {
  ...
  for (; r < e.length && !i; ) {
    let t = e[r];
    typeof t == `string` && !Ml.has(t) && We(t).values.length && (i = e[r]),
      r++;
  }
  if (i && n) for (let r of t) e[r] = Yt(n, i);
}
function Qt(e, t, n) {
...
function rn(e, t, n = {}) {
  let [r, i, a] = tn(e, n),
    o = (e) => {
      ...
      let a = (e) => {
        nn(e) && (r(e), n.removeEventListener(`pointerleave`, a));
      };
...
function ln(e, t, n = {}) {
  let [r, i, a] = tn(e, n),
    o = (e) => {
      ...
      let a = t(r, e),
        o = (e, t) => {
          S.removeEventListener(`pointerup`, s),
            S.removeEventListener(`pointercancel`, c),
            Kl.has(r) && Kl.delete(r),
            cn(e) && typeof a == `function` && a(e, { success: t });
        },
        s = (e) => {
          o(
            e,
            r === S || r === document || n.useGlobalTarget || Ul(r, e.target),
          );
        },
        c = (e) => {
          o(e, !1);
        };
      S.addEventListener(`pointerup`, s, i),
        S.addEventListener(`pointercancel`, c, i);
    };
  return (
    r.forEach((e) => {
      let t = n.useGlobalTarget ? S : e;
      t.addEventListener(`pointerdown`, o, i),
        Vt(e) &&
          (e.addEventListener(`focus`, (e) => ql(e, i)),
          !an(e) && !e.hasAttribute(`tabindex`) && (e.tabIndex = 0));
    }),
    a
  );
}
...
function dn({ target: e, borderBoxSize: t }) {
  var n;
  (n = Jl.get(e)) == null ||
    n.forEach((n) => {
      n(e, {
...
function pn() {
  typeof ResizeObserver > `u` || (Yl = new ResizeObserver(fn));
}
function mn(e, t) {
  Yl || pn();
  let n = Qt(e);
  return (
    n.forEach((e) => {
      let n = Jl.get(e);
      n || ((n = new Set()), Jl.set(e, n)), n.add(t), Yl?.observe(e);
    }),
    () => {
      n.forEach((e) => {
        let n = Jl.get(e);
        n?.delete(t), n?.size || Yl?.unobserve(e);
      });
    }
  );
}
  ...
  return (
    ...
    () => {
      $l.delete(e),
        !$l.size &&
          typeof eu == `function` &&
          (S.removeEventListener(`resize`, eu), (eu = void 0));
    }
  );
}
function _n(e, t) {
  return typeof e == `function` ? gn(e) : mn(e, t);
}
function vn(e, t) {
  let n,
    r = () => {
...
function xn(e, t, n) {
  ...
  e.attach(
    (t, n) => ((a = t), (o = (e) => n(Sn(e, s))), R.postRender(l), e.get()),
    c,
  );
  let u;
  return (
    X(t) && ((u = t.on(`change`, (t) => e.set(Sn(t, s)))), e.on(`destroy`, u)),
    u
  );
}
function Sn(e, t) {
...
function Tn({ children: e, isPresent: t, anchorX: n }) {
  let r = a(),
    i = h(null),
    o = h({ width: 0, height: 0, top: 0, left: 0, right: 0 }),
    { nonce: c } = _(Z);
  return (
    s(() => {
      let { width: e, height: a, top: s, left: l, right: u } = o.current;
    ...
    m(iu, { isPresent: t, childRef: i, sizeRef: o, children: g(e, { ref: i }) })
  );
}
function En() {
  return new Map();
...
function Nn(e) {
  e && (_u = (t) => (t.startsWith(`on`) ? !Mn(t) : e(t)));
}
function Pn(e, t, n) {
  let r = {};
  for (let i in e) {
    if (i === `values` && typeof e.values == `object`) continue;
    (_u(i) ||
      (n === !0 && Mn(i)) ||
      (!t && !Mn(i)) ||
...
function Fn({ children: e, isValidProp: t, ...n }) {
  t && Nn(t), (n = { ..._(Z), ...n }), (n.isStatic = D(() => n.isStatic));
  let r = v(
    () => n,
    [JSON.stringify(n.transition), n.transformPagePoint, n.reducedMotion],
  );
  return m(Z.Provider, { value: r, children: e });
}
function In(e) {
...
function Rn(e) {
  return In(e.animate) || wu.some((t) => Ln(e[t]));
}
function zn(e) {
...
function Bn(e, t) {
  if (Rn(e)) {
    ...
    return {
      initial: t === !1 || Ln(t) ? t : void 0,
      animate: Ln(n) ? n : void 0,
    };
  }
  return e.inherit === !1 ? {} : t;
}
function Vn(e) {
  let { initial: t, animate: n } = Bn(e, _(vu));
  return v(() => ({ initial: t, animate: n }), [Hn(t), Hn(n)]);
}
function Hn(e) {
  ...
  return y(
    (r) => {
      r && e.onMount && e.onMount(r),
        ...
        n && (typeof n == `function` ? n(r) : Un(n) && (n.current = r));
    },
    [t],
  );
}
function Gn(e, t, n, r, i) {
  ...
  let g = h(!1);
  s(() => {
    p && g.current && p.update(n, u);
  });
  let v = n[xu],
    y = h(
      !!v &&
        !(a = S.MotionHandoffIsComplete)?.call(S, v) &&
        (o = S.MotionHasOptimisedAnimation)?.call(S, v),
    );
  return (
    ns(() => {
      p &&
    ...
    x(() => {
      p &&
        ...
        (y.current &&=
          (queueMicrotask(() => {
            var e;
            (e = S.MotionHandoffMarkAsComplete) == null || e.call(S, v);
          }),
          !1)));
    }),
    p
...
function Kn(e, t, n, r) {
  ...
  (e.projection = new n(
    e.latestValues,
    t[`data-framer-portal-id`] ? void 0 : qn(e.parent),
  )),
    e.projection.setOptions({
      layoutId: i,
      layout: a,
      alwaysMeasureLayout: !!o || (s && Un(s)),
      visualElement: e,
...
function qn(e) {
  if (e) return e.options.allowProjection === !1 ? qn(e.parent) : e.projection;
}
function Jn({
  preloadedFeatures: e,
  ...
  function o(i, o) {
    ...
    if (!l && ts) {
      ...
      let n = Zn(c);
      (s = n.MeasureLayout),
        (u.visualElement = Gn(a, d, c, t, n.ProjectionNode));
    }
    return b(vu.Provider, {
      value: u,
      children: [
        s && u.visualElement
          ? m(s, { visualElement: u.visualElement, ...c })
          : null,
        n(a, i, Wn(d, u.visualElement, o), d, l, u.visualElement),
      ],
    });
  }
  o.displayName = `motion.${typeof a == `string` ? a : `create(${a.displayName ?? a.name ?? ``})`}`;
  let s = i(o);
  return (s[Tu] = a), s;
}
...
function Qn(e) {
  for (let t in e) (Eu[t] = e[t]), Bs(t) && (Eu[t].isCSSVariable = !0);
}
function $n(e, t, n) {
  let r = ``,
    i = !0;
...
function rr({ scrapeMotionValuesFromProps: e, createRenderState: t }, n, r, i) {
  let a = { latestValues: ir(n, r, i, e), renderState: t() };
  return a;
}
function ir(e, t, n, r) {
  let i = {},
    a = r(e, {});
  for (let e in a) i[e] = er(a[e]);
...
function lr({ transformTemplate: e }, t) {
  return v(() => {
    let n = Au();
...
function ur(e, t) {
  let n = e.style || {},
    r = {};
  return cr(r, n, e), Object.assign(r, lr(e, t)), r;
}
function dr(e, t) {
  let n = {},
    r = ur(e, t);
...
function pr(
  ...
  d.transform && ((f.transform = d.transform), delete d.transform),
    ...
    n !== void 0 && (d.y = n),
    r !== void 0 && (d.scale = r),
    i !== void 0 && fr(d, i, a, o, !1);
}
function mr(e, t, n, r) {
  let i = v(() => {
    let n = Nu();
    return (
      pr(n, t, Pu(r), e.transformTemplate, e.style),
      { ...n.attrs, style: { ...n.style } }
    );
  }, [t]);
  if (e.style) {
    let t = {};
    cr(t, e.style, e), (i.style = { ...t, ...i.style });
  }
  return i;
}
function hr(e) {
  return typeof e != `string` || e.includes(`-`)
    ? !1
    : !!(Fu.indexOf(e) > -1 || /[A-Z]/u.test(e));
}
function gr(e = !1) {
  let n = (n, r, i, { latestValues: a }, o) => {
    let s = hr(n) ? mr : dr,
      c = s(r, a, o, n),
      l = Pn(r, typeof n == `string`, e),
      u = n === C ? {} : { ...l, ...c, ref: i },
      { children: d } = r,
      f = v(() => (X(d) ? d.get() : d), [d]);
    return t(n, { ...u, children: f });
  };
  return n;
}
function _r(e, t, n) {
  ...
  for (let o in i)
    (X(i[o]) ||
      (t.style && X(t.style[o])) ||
      or(o, e) ||
      (r = n?.getValue(o))?.liveStyle !== void 0) &&
      (a[o] = i[o]);
  return a;
}
function vr(e, t, n) {
...
function Sr(e) {
  return Ru(e) ? e[e.length - 1] || 0 : e;
}
function Cr(e, t) {
  let n = br(e, t),
    { transitionEnd: r = {}, transition: i = {}, ...a } = n || {};
  for (let t in ((a = { ...a, ...r }), a)) {
    let n = Sr(a[t]);
    xr(e, t, n);
  }
}
...
function Ar(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
  ...
  for (let t in s) {
    ...
    if (S.MotionHandoffAnimation) {
      let n = Er(e);
      if (n) {
        let e = S.MotionHandoffAnimation(n, t, R);
        e !== null && ((o.startTime = e), (d = !0));
      }
    }
    Tr(e, t),
      r.start(
        Gu(t, r, i, e.shouldReduceMotion && yl.has(t) ? { type: !1 } : o, e, d),
      );
    let f = r.animation;
    f && c.push(f);
  }
...
function jr(e, t, n = {}) {
  ...
  let i = br(
      e,
      t,
      n.type === `exit` ? (r = e.presenceContext)?.custom : void 0,
    ),
    { transition: a = e.getDefaultTransition() || {} } = i || {};
  n.transitionOverride && (a = n.transitionOverride);
  let o = i ? () => Promise.all(Ar(e, i, n)) : () => Promise.resolve(),
    s =
...
function Pr(e, t, n = {}) {
  ...
  if (Array.isArray(t)) {
    ...
    let i = typeof t == `function` ? br(e, t, n.custom) : t;
    r = Promise.all(Ar(e, i, n));
  }
  return r.then(() => {
    e.notify(`AnimationComplete`, t);
  });
...
function Lr(e) {
  return (t) =>
    Promise.all(t.map(({ animation: t, options: n }) => Pr(e, t, n)));
}
function Rr(e) {
  let t = Lr(e),
    n = Vr(),
    ...
    i = (t) => (n, r) => {
      var i;
      let a = br(e, r, t === `exit` ? (i = e.presenceContext)?.custom : void 0);
      if (a) {
  ...
  function o(a) {
    ...
    if (l.size) {
      ...
      if (typeof o.initial != `boolean`) {
        let n = br(e, Array.isArray(o.initial) ? o.initial[0] : o.initial);
  ...
  function s(t, r) {
    ...
    (i = e.variantChildren) == null ||
      i.forEach((e) => {
        var n;
        return (n = e.animationState)?.setActive(t, r);
      }),
      (n[t].isActive = r);
    let a = o(t);
...
function Kr(e, t, n, r = 0.5) {
  (e.origin = r),
    ...
    ((e.scale >= td && e.scale <= nd) || isNaN(e.scale)) && (e.scale = 1),
    ((e.translate >= id && e.translate <= ad) || isNaN(e.translate)) &&
      (e.translate = 0);
}
function qr(e, t, n, r) {
...
function di(e, t, n, r, i) {
  return i !== void 0 && (e = ui(e, i, r)), ui(e, n, r) + t;
}
function fi(e, t = 0, n = 1, r, i) {
  (e.min = di(e.min, t, n, r, i)), (e.max = di(e.max, t, n, r, i));
}
function pi(e, { x: t, y: n }) {
  fi(e.x, t.translate, t.scale, t.originPoint),
    fi(e.y, n.translate, n.scale, n.originPoint);
}
  ...
  for (let s = 0; s < i; s++) {
    ...
    (i && i.props.style && i.props.style.display === `contents`) ||
      (r &&
        ...
        a.scroll &&
        a !== a.root &&
        _i(e, { x: -a.scroll.offset.x, y: -a.scroll.offset.y }),
      o && ((t.x *= o.x.scale), (t.y *= o.y.scale), pi(e, o)),
      r && si(a.latestValues) && _i(e, a.latestValues));
  }
  t.x < vd && t.x > _d && (t.x = 1), t.y < vd && t.y > _d && (t.y = 1);
}
function hi(e, t) {
  (e.min += t), (e.max += t);
}
function gi(e, t, n, r, i = 0.5) {
  let a = q(e.min, e.max, i);
  fi(e, t, n, a, r);
}
function _i(e, t) {
  gi(e.x, t.x, t.scaleX, t.scale, t.originX),
    gi(e.y, t.y, t.scaleY, t.scale, t.originY);
}
function vi(e, t) {
  return ni(ii(e.getBoundingClientRect(), t));
}
function yi(e, t, n) {
  let r = vi(e, n),
    { scroll: i } = t;
  return i && (hi(r.x, i.offset.x), hi(r.y, i.offset.y)), r;
}
function bi(e, t) {
...
function Oi(e, { top: t, left: n, bottom: r, right: i }) {
  return { x: Di(e.x, n, i), y: Di(e.y, t, r) };
}
function ki(e, t) {
  let n = t.min - e.min,
    r = t.max - e.max;
...
function Ai(e, t) {
  return { x: ki(e.x, t.x), y: ki(e.y, t.y) };
}
function ji(e, t) {
  let n = 0.5,
    r = O(e),
...
function Vi(e, t, n, r, i, a) {
  i
    ? ((e.opacity = q(0, n.opacity ?? 1, Id(r))),
      (e.opacityExit = q(t.opacity ?? 1, 0, Ld(r))))
    : a && (e.opacity = q(t.opacity ?? 1, n.opacity ?? 1, r));
  for (let i = 0; i < Nd; i++) {
    let a = `border${Md[i]}Radius`,
      o = Hi(t, a),
      s = Hi(n, a);
    if (o === void 0 && s === void 0) continue;
    (o ||= 0), (s ||= 0);
    let c = o === 0 || s === 0 || Fd(o) === Fd(s);
    c
      ? ((e[a] = Math.max(q(Pd(o), Pd(s), r), 0)),
...
function Ki(e, t, n, r, i) {
  return (
    (e -= t), (e = ui(e, 1 / n, r)), i !== void 0 && (e = ui(e, 1 / i, r)), e
  );
}
function qi(e, t = 0, n = 1, r = 0.5, i, a = e, o = e) {
  if (U.test(t)) {
    t = parseFloat(t);
    let e = q(o.min, o.max, t / 100);
    t = e - o.min;
  }
...
function Ji(e, t, [n, r, i], a, o) {
  qi(e, t[n], t[r], t[i], t.scale, a, o);
}
function Yi(e, t, n, r) {
  Ji(e.x, t, Rd, n ? n.x : void 0, r ? r.x : void 0),
    Ji(e.y, t, zd, n ? n.y : void 0, r ? r.y : void 0);
}
function Xi(e) {
...
function oa(e) {
  ...
  if (S.MotionHasOptimisedAnimation(n, `transform`)) {
    ...
    S.MotionCancelOptimisedAnimation(n, `transform`, R, !(t || r));
  }
  let { parent: r } = e;
...
function sa({
  ...
  return class {
      ...
      (this.id = Gd++),
        ...
        (this.updateProjection = () => {
          (this.projectionUpdateScheduled = !1),
            L.value &&
              (Vd.nodes =
                Vd.calculatedTargetDeltas =
                Vd.calculatedProjections =
                  0),
            this.nodes.forEach(ua),
            this.nodes.forEach(_a),
            this.nodes.forEach(va),
            this.nodes.forEach(da),
            L.addProjectionMetrics && L.addProjectionMetrics(Vd);
        }),
    ...
    addEventListener(e, t) {
      return (
        this.eventHandlers.has(e) || this.eventHandlers.set(e, new fs()),
    ...
    mount(t) {
      ...
      (this.isSVG = un(t) && !yn(t)), (this.instance = t);
        ...
        e(t, () => {
          (this.root.updateBlockedByResize = !0),
            ...
            Dd.hasAnimatedSinceResize &&
              ((Dd.hasAnimatedSinceResize = !1), this.nodes.forEach(ga));
        });
      }
        ...
        this.options.animate !== !1 &&
          ...
          this.addEventListener(
            ...
            ({
              ...
              let a = this.options.transition || i.getDefaultTransition() || Kd,
                { onLayoutAnimationStart: o, onLayoutAnimationComplete: s } =
                  i.getProps(),
                c = !this.targetLayout || !ta(this.targetLayout, r),
                l = !t && n;
              if (
    ...
    willUpdate(e = !0) {
      ...
      if (
        (S.MotionCancelOptimisedAnimation &&
    ...
    update() {
      ...
      if (e) {
        this.unblockUpdate(), this.clearAllSnapshots(), this.nodes.forEach(pa);
        return;
      }
      this.isUpdating || this.nodes.forEach(ma),
        (this.isUpdating = !1),
      ...
      let t = V.now();
      (B.delta = j(0, 1e3 / 60, t - B.timestamp)),
        (B.timestamp = t),
        (B.isProcessing = !0),
        Is.update.process(B),
        Is.preRender.process(B),
        Is.render.process(B),
        (B.isProcessing = !1);
    }
    didUpdate() {
      this.updateScheduled ||
        ((this.updateScheduled = !0), Vl.read(this.scheduleUpdate));
    }
    clearAllSnapshots() {
      this.nodes.forEach(fa), this.sharedNodes.forEach(ba);
    }
    ...
    resetTransform() {
      ...
      let e =
        ...
        t = this.projectionDelta && !Zi(this.projectionDelta),
        n = this.getTransformTemplate(),
        r = n ? n(this.latestValues, ``) : void 0,
        a = r !== this.prevTransformTemplateValue;
      e &&
        this.instance &&
        (t || si(this.latestValues) || a) &&
        (i(this.instance, r),
        (this.shouldResetTransform = !1),
        this.scheduleRender());
    }
    ...
    measurePageBox() {
      ...
      let n = t.measureViewportBox(),
        r = (e = this.scroll)?.wasRoot || this.path.some(Oa);
      if (!r) {
        let { scroll: e } = this.root;
        e && (hi(n.x, e.offset.x), hi(n.y, e.offset.y));
      }
      return n;
    }
    removeElementScroll(e) {
      var t;
      let n = $();
      if ((A(n, e), (t = this.scroll)?.wasRoot)) return n;
      for (let t = 0; t < this.path.length; t++) {
        ...
        r !== this.root &&
          i &&
          a.layoutScroll &&
          (i.wasRoot && A(n, e), hi(n.x, i.offset.x), hi(n.y, i.offset.y));
      }
      return n;
    }
    applyTransform(e, t = !1) {
      ...
      for (let e = 0; e < this.path.length; e++) {
        ...
        !t &&
          ...
          r.scroll &&
          r !== r.root &&
          _i(n, { x: -r.scroll.offset.x, y: -r.scroll.offset.y }),
          si(r.latestValues) && _i(n, r.latestValues);
      }
      return si(this.latestValues) && _i(n, this.latestValues), n;
    }
    removeTransform(e) {
      let t = $();
      A(t, e);
      for (let e = 0; e < this.path.length; e++) {
        let n = this.path[e];
        if (!n.instance || !si(n.latestValues)) continue;
        oi(n.latestValues) && n.updateSnapshot();
        let r = $(),
          i = n.measurePageBox();
        A(r, i),
          Yi(t, n.latestValues, n.snapshot ? n.snapshot.layoutBox : void 0, r);
      }
      return si(this.latestValues) && Yi(t, this.latestValues), t;
    }
    setTargetDelta(e) {
      (this.targetDelta = e),
    ...
    resolveTargetDelta(e = !1) {
      ...
      let r = !!this.resumingFrom || this !== n,
        i = !(
          ...
          (t = this.parent)?.isProjectionDirty ||
          this.attemptToResolveRelativeTarget ||
          this.root.updateBlockedByResize
        );
      if (i) return;
      let { layout: a, layoutId: o } = this.options;
      if (!(!this.layout || !(a || o))) {
        if (
        ...
        if (!(!this.relativeTarget && !this.targetDelta)) {
          if (
            (this.target ||
              ((this.target = $()), (this.targetWithTransforms = $())),
            this.relativeTarget &&
            this.relativeTargetOrigin &&
            this.relativeParent &&
            ...
            this.animationProgress !== 1
              ? ((this.relativeParent = e),
                ...
                (this.relativeTarget = $()),
                (this.relativeTargetOrigin = $()),
                Zr(this.relativeTargetOrigin, this.target, e.target),
                A(this.relativeTarget, this.relativeTargetOrigin))
              : (this.relativeParent = this.relativeTarget = void 0);
          }
          L.value && Vd.calculatedTargetDeltas++;
        }
      }
    }
    ...
    calcProjection() {
      ...
      let t = this.getLead(),
        ...
        r = !0;
      if (
        ((this.isProjectionDirty || (e = this.parent)?.isProjectionDirty) &&
          (r = !1),
        n &&
          (this.isSharedProjectionDirty || this.isTransformDirty) &&
          (r = !1),
        this.resolvedRelativeTargetAt === B.timestamp && (r = !1),
        r)
      )
        return;
      ...
      let o = this.treeScale.x,
        s = this.treeScale.y;
      mi(this.layoutCorrected, this.treeScale, this.path, n),
        t.layout &&
          !t.target &&
          (this.treeScale.x !== 1 || this.treeScale.y !== 1) &&
          ((t.target = t.layout.layoutBox), (t.targetWithTransforms = $()));
      let { target: c } = t;
      if (!c) {
      ...
      !this.projectionDelta || !this.prevProjectionDelta
        ...
        : (Gi(this.prevProjectionDelta.x, this.projectionDelta.x),
          Gi(this.prevProjectionDelta.y, this.projectionDelta.y)),
        qr(this.projectionDelta, this.layoutCorrected, c, this.latestValues),
        (this.treeScale.x !== o ||
          this.treeScale.y !== s ||
        ...
        L.value && Vd.calculatedProjections++;
    }
    hide() {
      this.isVisible = !1;
    }
    ...
    createProjectionDeltas() {
      (this.prevProjectionDelta = sd()),
        (this.projectionDelta = sd()),
        (this.projectionDeltaWithTransform = sd());
    }
    setAnimationOrigin(e, t = !1) {
      ...
      let o = $(),
        ...
        f = !!(l && !d && this.options.crossfade === !0 && !this.path.some(wa));
      this.animationProgress = 0;
      let p;
      (this.mixTargetDelta = (t) => {
        ...
        xa(a.x, e.x, n),
          ...
          this.relativeTarget &&
            ...
            Ca(this.relativeTarget, this.relativeTargetOrigin, o, n),
            p && $i(this.relativeTarget, p) && (this.isProjectionDirty = !1),
            (p ||= $()),
            A(p, this.relativeTarget)),
          l &&
            ((this.animationValues = i), Vi(i, r, this.latestValues, n, f, d)),
          this.root.scheduleUpdateProjection(),
          this.scheduleRender(),
    ...
    startAnimation(e) {
      ...
      this.notifyListeners(`animationStart`),
        ...
        (r = (n = this.resumingFrom)?.currentAnimation) == null || r.stop(),
        ...
        (this.pendingAnimation = R.update(() => {
          (Dd.hasAnimatedSinceResize = !0),
            ...
            (this.currentAnimation = Bi(this.motionValue, [0, 1e3], {
              ...e,
              velocity: 0,
              isSync: !0,
              onUpdate: (t) => {
    ...
    applyTransformsToTarget() {
      ...
      if (!(!t || !n || !r)) {
        if (
          ...
          this.layout &&
          r &&
          Da(this.options.animationType, this.layout.layoutBox, r.layoutBox)
        ) {
          n = this.target || $();
    ...
    registerSharedNode(e, t) {
      this.sharedNodes.has(e) || this.sharedNodes.set(e, new Bd());
    ...
    getLead() {
      ...
      return (t && (e = this.getStack())?.lead) || this;
    }
    getPrevLead() {
      var e;
      let { layoutId: t } = this.options;
      return t ? (e = this.getStack())?.prevLead : void 0;
    }
    getStack() {
    ...
    resetSkewAndRotation() {
      ...
      if (
        ...
        return;
      let r = {};
      n.z && aa(`z`, e, r, this.animationValues);
      for (let t = 0; t < Hd.length; t++)
        aa(`rotate${Hd[t]}`, e, r, this.animationValues),
          aa(`skew${Hd[t]}`, e, r, this.animationValues);
    ...
    getProjectionStyles(e) {
      ...
      if (this.needsReset)
        return (
          (this.needsReset = !1),
          (t.opacity = ``),
          (t.pointerEvents = er(e?.pointerEvents) || ``),
      ...
      for (let e in ((t.transformOrigin = `${a.origin * 100}% ${o.origin * 100}% 0`),
      r.animationValues
        ? (t.opacity =
            r === this
      ...
      Eu)) {
        ...
        let { correct: n, applyTo: a, isCSSVariable: o } = Eu[e],
          s = t.transform === `none` ? i[e] : n(i[e], r);
        if (a) {
          let e = a.length;
          for (let n = 0; n < e; n++) t[a[n]] = s;
        } else
          o ? (this.options.visualElement.renderState.vars[e] = s) : (t[e] = s);
      }
      return (
        this.options.layoutId &&
          (t.pointerEvents = r === this ? er(e?.pointerEvents) || `` : `none`),
        t
      );
    }
    clearSnapshot() {
    ...
    resetTree() {
      this.root.nodes.forEach((e) => {
        var t;
        return (t = e.currentAnimation)?.stop();
      }),
...
function la(e) {
  var t;
  let n = (t = e.resumeFrom)?.snapshot || e.snapshot;
  if (e.isLead() && e.layout && n && e.hasListeners(`didUpdate`)) {
    ...
    qr(o, t, n.layoutBox);
    let s = sd();
    a ? qr(s, e.applyTransform(r, !0), n.measuredBox) : qr(s, t, n.layoutBox);
    let c = !Zi(o),
      l = !1;
    if (!e.resumeFrom) {
...
function Ca(e, t, n, r) {
  Sa(e.x, t.x, n.x, r), Sa(e.y, t.y, n.y, r);
}
function wa(e) {
...
function Da(e, t, n) {
  return (
    e === `position` || (e === `preserve-aspect` && !Gr(na(t), na(n), 0.2))
  );
}
function Oa(e) {
  var t;
  return e !== e.root && (t = e.scroll)?.wasRoot;
}
function ka(e, t, n) {
  let { props: r } = e;
  e.animationState &&
...
function ja({ root: e, ...t }) {
  let n = e || document;
  rf.has(n) || rf.set(n, {});
  let r = rf.get(n),
    i = JSON.stringify(t);
  return r[i] || (r[i] = new IntersectionObserver(sf, { root: e, ...t })), r[i];
}
function Ma(e, t, n) {
  let r = ja(t);
  return (
...
function Pa(e, { style: t, vars: n }, r, i) {
  for (let a in (Object.assign(e.style, t, i && i.getProjectionStyles(r)), n))
...
function Ia(e, t, n, r) {
  for (let n in (Pa(e, t, void 0, r), t.attrs))
    e.setAttribute(mf.has(n) ? n : yu(n), t.attrs[n]);
}
function La(e, t, n, r) {
  let i = n[t],
    { length: a, position: o } = Tf[t],
    s = i.current,
    c = n.time;
  (i.current = e[`scroll${o}`]),
    ...
    (i.progress = ds(0, i.scrollLength, i.current));
  let l = r - c;
  i.velocity = l > Sf ? 0 : Pe(i.current - s, l);
}
function Ra(e, t, n) {
  La(e, `x`, t, n), La(e, `y`, t, n), (t.time = n);
}
function za(e, t) {
  let n = { x: 0, y: 0 },
    r = e;
...
function Va(e, t, n, r) {
  ...
  return (
    typeof e == `number`
      ...
      : typeof e == `string` &&
        ((e = e.trim()),
        (i = e.includes(` `) ? e.split(` `) : [e, Ef[e] ? e : `0`])),
    (a = Ba(i[0], n, r)),
    (o = Ba(i[1], t)),
    a - o
  );
...
function Ua(e, t, n) {
  let { offset: r = Of.All } = n,
    { target: i = e, axis: a = `y` } = n,
    o = a === `y` ? `height` : `width`,
    s = i === e ? kf : za(i, e),
    c = i === e ? { width: e.scrollWidth, height: e.scrollHeight } : Ha(i),
    l = { width: e.clientWidth, height: e.clientHeight };
  t[a].offset.length = 0;
  let u = !t[a].interpolate,
    d = r.length;
  for (let e = 0; e < d; e++) {
    let n = Va(r[e], l[o], c[o], s[a]);
...
function Ga(e, t, n, r = {}) {
  return {
    measure: (t) => {
      Wa(e, r.target, n), Ra(e, n, t), (r.offset || r.target) && Ua(e, n, r);
    },
    notify: () => t(n),
  };
}
function Ka(e, { container: t = document.scrollingElement, ...n } = {}) {
  if (!t) return P;
  let r = Mf.get(t);
  r || ((r = new Set()), Mf.set(t, r));
  let i = wf(),
    a = Ga(t, e, i, n);
  if ((r.add(a), !Af.has(t))) {
    let e = () => {
    ...
    Af.set(t, i);
    let a = Nf(t);
    S.addEventListener(`resize`, i, { passive: !0 }),
      t !== document.documentElement && jf.set(t, _n(t, i)),
  ...
  return (
    ...
    () => {
      ...
      Af.delete(t),
        r &&
          (Nf(t).removeEventListener(`scroll`, r),
          (e = jf.get(t)) == null || e(),
...
function Ja({ source: e, container: t, ...n }) {
  let { axis: r } = n;
  e && (t = e);
  let i = Pf.get(t) ?? new Map();
  Pf.set(t, i);
  let a = n.target ?? `self`,
    o = i.get(a) ?? {},
    s = r + (n.offset ?? []).join(`,`);
...
function Qa(
  ...
  return typeof e == `function` ? Za(e, i) : Ya(e, i);
}
function $a(e, t) {
  os(
    !!(!t || t.current),
...
function eo({ container: e, target: t, layoutEffect: n = !0, ...r } = {}) {
  let i = D(Ff),
    a = n ? ns : x;
  return (
    a(
...
function ro(e) {
  (Rl.current = []), e();
  let t = no(Rl.current, e);
  return (Rl.current = void 0), t;
}
function io(e, t, n, r) {
  if (typeof e == `function`) return ro(e);
  let i = typeof t == `function` ? t : bn(t, n, r);
  return Array.isArray(e) ? ao(e, i) : ao([e], ([e]) => i(e));
}
function ao(e, t) {
  let n = D(() => []);
  return no(e, () => {
...
function oo(e, t = {}) {
  ...
  if (n) return io(r);
  let i = to(r());
  return s(() => xn(i, e, t), [i, JSON.stringify(t)]), i;
}
function so() {
  !md.current && ei();
  let [e] = w(pd.current);
...
function fo(e, t) {
  if (Array.isArray(t)) return uo(e, t);
  if (typeof t == `string`) return uo(e, [t]);
  Cr(e, t);
}
function po() {
  let e = !1,
    ...
    n = {
      ...
      start(n, r) {
        ...
        return (
          t.forEach((e) => {
            i.push(Pr(e, n, { transitionOverride: r }));
          }),
          Promise.all(i)
        );
      },
...
function So(e, { defaultTransition: t = {}, ...n } = {}, r, i) {
  ...
  for (let n = 0; n < e.length; n++) {
    ...
    let g = 0,
      _ = (e, n, r, o = 0, s = 0) => {
        ...
        if ((T > 0 && _t(u, T), c.length === 1 && c.unshift(null), m)) {
          M(m < Rf, `Repeat count too high, must be less than 20`),
            (b = go(b, m));
          let e = [...c],
            t = [...u];
        ...
        let ee = w + b;
        yo(r, c, y, u, w, ee), (g = Math.max(x + b, g)), (f = Math.max(ee, f));
      };
    if (X(p)) {
      let e = Co(p, s);
      _(m, h, wo(`default`, e));
      ...
      for (let n = 0; n < t; n++) {
        ...
        let r = e[n],
          i = Co(r, s);
        for (let e in m) _(m[e], Eo(h, e), wo(e, i), n, t);
      }
    }
    (u = d), (d += g);
  }
    ...
    s.forEach((e, r) => {
      for (let i in e) {
        ...
        for (let e = 0; e < a.length; e++) {
          ...
          s.push(n), c.push(ds(0, f, t)), l.push(r || `easeOut`);
        }
        c[0] !== 0 && (c.unshift(0), s.unshift(s[0]), l.unshift(Lf)),
...
function Oo(e) {
  let t = {
    ...
    n = un(e) && !yn(e) ? new hf(t) : new pf(t);
  n.mount(e), fd.set(e, n);
}
function ko(e) {
  let t = {
      presenceContext: null,
...
function Ao(e, t) {
  return X(e) || typeof e == `number` || (typeof e == `string` && !mo(t));
}
function jo(e, t, n, r) {
  let i = [];
  if (Ao(e, t)) i.push(Bi(e, (mo(t) && t.default) || t, n && (n.default || n)));
  else {
    let a = ho(e, t, r),
      o = a.length;
    M(!!o, `No valid elements provided.`);
    for (let e = 0; e < o; e++) {
      let r = a[e],
        s = r instanceof Element ? Oo : ko;
      fd.has(r) || s(r);
      let c = fd.get(r),
        l = { ...n };
      `delay` in l && typeof l.delay == `function` && (l.delay = l.delay(e, o)),
        i.push(...Ar(c, { ...t, transition: l }, {}));
    }
  }
  return i;
}
...
function Io(e) {
  return typeof e == `object` && !!e && Tu in e;
}
function Lo(e) {
  if (Io(e)) return e[Tu];
}
...
function zo(e) {
  Xd.current &&
    ((Xd.current.isUpdating = !1), Xd.current.blockUpdate(), e && e());
}
function Bo() {
  let e = y(() => {
    let e = Xd.current;
...
function Vo(e, t, { root: n, margin: r, amount: i = `some` } = {}) {
  let a = Qt(e),
    o = new WeakMap(),
    s = (e) => {
      e.forEach((e) => {
...
function Go(
  { children: e, as: t = `ul`, axis: n = `y`, onReorder: r, values: i, ...a },
  o,
) {
  let s = D(() => vf[t]),
    c = [],
    l = h(!1);
  M(!!i, `Reorder.Group must be provided a values prop`);
  let u = {
    axis: n,
    registerItem: (e, t) => {
      let r = c.findIndex((t) => e === t.value);
      r === -1 ? c.push({ value: e, layout: t[n] }) : (c[r].layout = t[n]),
        c.sort(qo);
    },
    updateOrder: (e, t, n) => {
      if (l.current) return;
      let a = Wo(c, e, t, n);
      c !== a &&
        ((l.current = !0), r(a.map(Ko).filter((e) => i.indexOf(e) !== -1)));
    },
  };
  return (
    x(() => {
    ...
    m(s, {
      ...
      ref: o,
      ignoreStrict: !0,
      children: m(Jf.Provider, { value: u, children: e }),
    })
  );
}
function Ko(e) {
...
function Yo(
  ...
  let c = D(() => vf[r]),
    l = _(Jf),
    u = { x: Jo(t.x), y: Jo(t.y) },
    d = io([u.x, u.y], ([e, t]) => (e || t ? 1 : `unset`));
  M(!!l, `Reorder.Item must be a child of Reorder.Group`);
  let { axis: f, registerItem: p, updateOrder: h } = l;
  return m(c, {
    drag: f,
    ...o,
    dragSnapToOrigin: !0,
    style: { ...t, x: u.x, y: u.y, zIndex: d },
    layout: a,
    onDrag: (e, t) => {
      let { velocity: r } = t;
      r[f] && h(n, u[f].get(), r[f]), i && i(e, t);
    },
...
function Zo(e = 0.1, { startDelay: t = 0, from: n = 0, ease: r } = {}) {
  return (i, a) => {
    let o = typeof n == `number` ? n : Xo(n, a),
      s = Math.abs(o - i),
      c = e * s;
    if (r) {
      let t = a * e,
...
var Qo,
  ...
  Zf = e(() => {
    ...
    (vs = (e) => (t) => 1 - e(1 - t)),
    (ys = Ie(0.33, 1.53, 0.69, 0.99)),
    (bs = vs(ys)),
    (xs = _s(bs)),
    (Ss = (e) =>
      (e *= 2) < 1 ? 0.5 * bs(e) : 0.5 * (2 - 2 ** (-10 * (e - 1)))),
    ...
    (Ns = (e) => {
      if (As(e)) {
        ...
        return M(js[e] !== void 0, `Invalid easing type '${e}'`), js[e];
      return e;
    }),
    ...
    (V = {
      ...
      set: (e) => {
        (Ls = e), queueMicrotask(Be);
      },
    }),
    (Rs = { layout: 0, mainThread: 0, waapi: 0 }),
    (zs = (e) => (t) => typeof t == `string` && t.startsWith(e)),
    (Bs = zs(`--`)),
    (Vs = zs(`var(--`)),
    (Hs = (e) => {
      let t = Vs(e);
      return t ? Us.test(e.split(`/*`)[0].trim()) : !1;
    }),
    (Us =
    ...
    (Xs = (e, t) => (n) =>
      !!(
        (typeof n == `string` && Ys.test(n) && n.startsWith(e)) ||
    ...
    (Qs = (e) => j(0, 255, e)),
    ($s = { ...Ws, transform: (e) => Math.round(Qs(e)) }),
    (ec = {
      test: Xs(`rgb`, `red`),
    ...
    (tc = { test: Xs(`#`), parse: He, transform: ec.transform }),
    (nc = (e) => ({
      test: (t) =>
    ...
    (G = {
      test: (e) => ec.test(e) || tc.test(e) || oc.test(e),
      parse: (e) =>
        ec.test(e) ? ec.parse(e) : oc.test(e) ? oc.parse(e) : tc.parse(e),
      transform: (e) =>
        typeof e == `string`
          ? e
    ...
    (mc = (e) => (typeof e == `number` ? 0 : e)),
    (K = { test: Ue, parse: Ge, createTransformer: Ke, getAnimatableNone: qe }),
    (q = (e, t, n) => e + (t - e) * n),
    (hc = (e, t, n) => {
      let r = e * e,
        i = n * (t * t - r) + r;
    ...
    (kc = (e) => e !== null),
    (Ac = { decay: mt, inertia: mt, tween: xt, keyframes: xt, spring: pt }),
    (jc = class {
      constructor() {
        this.updateFinished();
      }
    ...
    (Nc = class extends jc {
      constructor(e) {
        super(),
          ...
          (this.stop = () => {
            ...
            n && n.updatedAt !== V.now() && this.tick(V.now()),
              (this.isStopped = !0),
              this.state !== `idle` &&
                (this.teardown(),
                (t = (e = this.options).onStop) == null || t.call(e));
          }),
          Rs.mainThread++,
          (this.options = e),
          this.initAnimation(),
      ...
      initAnimation() {
        ...
        s !== xt &&
          typeof o[0] != `number` &&
          ((this.mixKeyframes = us(Mc, it(o[0], o[1]))), (o = [0, 100]));
      ...
      tick(e, t = !1) {
        ...
        if (u) {
          let e = Math.min(this.currentTime, r) / o,
            t = Math.floor(e),
            n = e % 1;
          !n && e >= 1 && (n = 1), n === 1 && t--, (t = Math.min(t, u + 1));
          let i = !!(t % 2);
          i &&
            (d === `reverse`
              ? ((n = 1 - n), f && (n -= f / o))
      ...
      play() {
        ...
        let { driver: n = Oc, startTime: r } = this.options;
        (this.driver ||= n((e) => this.tick(e))),
          (t = (e = this.options).onPlay) == null || t.call(e);
    ...
    ($c = class {
      ...
      scheduleResolve() {
        (this.state = `scheduled`),
          this.isAsync
            ? (Yc.add(this),
              Xc || ((Xc = !0), R.read(jt), R.resolveKeyframes(At)))
      ...
      cancel() {
        this.state === `scheduled` &&
          (Yc.delete(this), (this.state = `pending`));
      }
      resume() {
    ...
    (ol = class extends jc {
        ...
        (this.animation = It(t, n, r, c, i)),
          ...
          (this.animation.onfinish = () => {
            if (((this.finishedTime = this.time), !i)) {
              ...
              this.updateMotionValue ? this.updateMotionValue(e) : Nt(t, n, e),
      ...
      get duration() {
        var e, t;
        let n =
          (t = (e = this.animation.effect)?.getComputedTiming)?.call(e)
            .duration || 0;
        return I(Number(n));
      }
      get time() {
      ...
      set time(e) {
        (this.finishedTime = null), (this.animation.currentTime = F(e));
      }
      get speed() {
      ...
      attachTimeline({ timeline: e, observe: t }) {
        ...
        return (
          ...
          e && tl() ? ((this.animation.timeline = e), P) : t(this)
        );
      }
    }),
    ...
    (ll = class extends ol {
      ...
      updateMotionValue(e) {
        ...
        t.setWithVelocity(o.sample(s - cl).value, o.sample(s).value, cl),
          o.stop();
      }
    }),
    (ul = new Set([`opacity`, `clipPath`, `filter`, `transform`])),
    (dl = Ne(() => Object.hasOwnProperty.call(Element.prototype, `animate`))),
    (fl = (e, t) =>
      t === `zIndex`
        ? !1
        : !!(
    ...
    (ml = class extends jc {
      constructor({
        ...
        super(),
          (this.stop = () => {
            ...
            this._animation &&
              ...
              (e = this.stopTimeline) == null || e.call(this)),
        ...
        let f = {
          ...
          p = l?.KeyframeResolver || $c;
        (this.keyframeResolver = new p(
          o,
          (e, t, n) => this.onKeyframesResolved(e, t, f, !n),
          s,
          c,
          l,
        )),
      ...
      onKeyframesResolved(e, t, n, r) {
        ...
        (this.resolvedAt = V.now()),
          Wt(e, i, a, o) ||
            ((N.instantAnimations || !s) && l?.(St(e, n, t)),
            (e[0] = e[e.length - 1]),
            (n.duration = 0),
            (n.repeat = 0));
        let u = r
            ? this.resolvedAt && this.resolvedAt - this.createdAt > pl
              ...
              : this.createdAt
            : void 0,
          d = { startTime: u, finalKeyframe: t, ...n, keyframes: e },
          f =
            !c && Ht(d)
              ? new ll({ ...d, element: d.motionValue.owner.current })
              : new Nc(d);
        f.finished.then(() => this.notifyFinished()).catch(P),
      ...
      get animation() {
        ...
        return (
          this._animation ||
            ((e = this.keyframeResolver) == null || e.resume(), Mt()),
          this._animation
        );
      }
      get duration() {
    ...
    (bl = (e) => (t) => t.test(e)),
    (xl = { test: (e) => e === `auto`, parse: (e) => e }),
    (Sl = [Ws, W, U, H, ic, rc, xl]),
    (Cl = (e) => Sl.find(bl(e))),
    (wl = {
      rotate: H,
      rotateX: H,
    ...
    (Dl = new Set([`brightness`, `contrast`, `saturate`, `opacity`])),
    (Ol = /\b([a-z-]*)\(.*?\)/gu),
    (kl = {
      ...K,
      getAnimatableNone: (e) => {
    ...
    (Nl = class extends $c {
      ...
      readKeyframes() {
        ...
        for (let n = 0; n < e.length; n++) {
          let r = e[n];
          if (typeof r == `string` && ((r = r.trim()), Hs(r))) {
            let i = Kt(r, t.current);
            i !== void 0 && (e[n] = i),
              n === e.length - 1 && (this.finalKeyframe = r);
          }
        }
        if ((this.resolveNoneKeyframes(), !yl.has(n) || e.length !== 2)) return;
        let [r, i] = e,
          a = Cl(r),
          o = Cl(i);
        if (a !== o)
      ...
      measureInitialState() {
        ...
        n === `height` && (this.suspendedScrollY = S.pageYOffset),
          (this.measuredOrigin = Jc[n](
            e.measureViewportBox(),
            S.getComputedStyle(e.current),
          )),
      ...
      measureEndState() {
        ...
        let a = r.length - 1,
          o = r[a];
        (r[a] = Jc[n](t.measureViewportBox(), S.getComputedStyle(t.current))),
          o !== null &&
            this.finalKeyframe === void 0 &&
            (this.finalKeyframe = o),
          (e = this.removedTransforms)?.length &&
    ...
    (Pl = new Set([`opacity`, `clipPath`, `filter`, `transform`])),
    (Fl = (e, t) => (t && typeof e == `number` ? t.transform(e) : e)),
    (Il = 30),
    (Ll = (e) => !isNaN(parseFloat(e))),
    (Rl = { current: void 0 }),
    (zl = class {
      constructor(e, t = {}) {
        (this.canTrackVelocity = null),
          ...
          (this.updateAndNotify = (e, t = !0) => {
            ...
            t &&
              ((r = this.events.renderRequest) == null ||
                r.notify(this.current));
          }),
          (this.hasAnimated = !1),
          this.setCurrent(e),
          (this.owner = t.owner);
      ...
      setCurrent(e) {
        (this.current = e),
          ...
          this.canTrackVelocity === null &&
            e !== void 0 &&
            (this.canTrackVelocity = Ll(this.current));
      }
      ...
      on(e, t) {
        this.events[e] || (this.events[e] = new fs());
      ...
      getVelocity() {
        ...
        if (
          ...
          return 0;
        let t = Math.min(this.updatedAt - this.prevUpdatedAt, Il);
        return Pe(
    ...
    (Bl = W.transform),
    ({ schedule: Vl, cancel: Hl } = ze(queueMicrotask, !1)),
    (Y = { x: !1, y: !1 }),
    (Ul = (e, t) => (t ? (e === t ? !0 : Ul(e, t.parentElement)) : !1)),
    (Wl = (e) =>
      e.pointerType === `mouse`
    ...
    (ql = (e, t) => {
      ...
      let r = on(() => {
        ...
        let e = on(() => {
          ...
          r = () => sn(n, `cancel`);
        n.addEventListener(`keyup`, e, t), n.addEventListener(`blur`, r, t);
      });
    ...
    (Xl = (e, t, n) => (r, i) =>
      i && i[0]
        ...
        : un(r) && `getBBox` in r
          ? r.getBBox()[t]
          : r[n]),
    (Zl = Xl(`inline`, `width`, `offsetWidth`)),
    (Ql = Xl(`block`, `height`, `offsetHeight`)),
    ($l = new Set()),
    (X = (e) => !!(e && e.getVelocity)),
    (tu = [...Sl, G, K]),
    (nu = (e) => tu.find(bl(e))),
    (ru = Ps.reduce((e, t) => ((e[t] = (e) => z(e)), e), {})),
    (Z = T({
    ...
    (au = ({
      ...
      return (
        ...
        s === `popLayout` &&
          (e = m(Tn, { isPresent: n, anchorX: c, children: e })),
        m(rs.Provider, { value: f, children: e })
      );
    }),
    (ou = (e) => e.key || ``),
    (su = ({
      ...
      if (u !== b) {
        ...
        for (let t = 0; t < S.length; t++) {
          let n = S[t],
            r = ou(n);
          d.includes(r) || (e.splice(t, 0, n), T.push(n));
        }
        return a === `wait` && T.length && (e = T), C(Dn(e)), x(u), null;
      }
      let { forceRender: ee } = _(es);
      return m(f, {
        children: S.map((e) => {
          let f = ou(e),
            h = o && !c ? !1 : u === S || d.includes(f),
            _ = () => {
              if (y.has(f)) y.set(f, !0);
              else return;
              let e = !0;
              y.forEach((t) => {
                t || (e = !1);
              }),
                e && (ee?.(), C(g.current), o && l?.(), r && r());
            };
          return m(
            au,
            {
    ...
    (cu = T(null)),
    (lu = (e) => !e.isLayoutDirty && e.willUpdate(!1)),
    (uu = (e) => e === !0),
    (du = (e) => uu(e === !0) || e === `id`),
    (fu = ({ children: e, id: t, inherit: n = !0 }) => {
      let r = _(es),
        i = _(cu),
        [a, o] = kn(),
        s = h(null),
      ...
      s.current === null &&
        (du(n) && c && (t = t ? c + `-` + t : c),
        (s.current = { id: t, group: (uu(n) && r.group) || An() }));
      let l = v(() => ({ ...s.current, forceRender: a }), [o]);
      return m(es.Provider, { value: l, children: e });
    }),
    (pu = T({ strict: !1 })),
    (mu = {
      animation: [
    ...
    (hu = {}),
    mu))
      hu[e] = { isEnabled: (t) => mu[e].some((e) => !!t[e]) };
    (gu = new Set(
    ...
    (vu = T({})),
      (yu = (e) => e.replace(/([a-z])([A-Z])/gu, `$1-$2`).toLowerCase()),
      (bu = `framerAppearId`),
      (xu = `data-` + yu(bu)),
      (Su = T({})),
      (Cu = [
      ...
      (wu = [`initial`, ...Cu]),
      (Tu = Symbol.for(`motionComponentSymbol`)),
      (Eu = {}),
      (Du = {
        x: `translateX`,
        y: `translateY`,
      ...
      (Mu = { offset: `strokeDashoffset`, array: `strokeDasharray` }),
      (Nu = () => ({ ...Au(), attrs: {} })),
      ...
      (Ru = (e) => Array.isArray(e)),
      (zu = (e) => e !== null),
      (Bu = { type: `spring`, stiffness: 500, damping: 25, restSpeed: 10 }),
      (Vu = (e) => ({
        type: `spring`,
        stiffness: 550,
      ...
      (Hu = { type: `keyframes`, duration: 0.8 }),
      (Uu = { type: `keyframes`, ease: [0.25, 0.1, 0.35, 1], duration: 0.3 }),
      (Wu = (e, { keyframes: t }) =>
        t.length > 2
          ? Hu
          : Wc.has(e)
      ...
      (Gu =
        ...
        (o) => {
          ...
          if (
            ...
            (N.instantAnimations || N.skipAnimations) &&
              ((d = !0), (u.duration = 0), (u.delay = 0)),
            (u.allowFlatten = !s.type && !s.ease),
            d && !a && t.get() !== void 0)
          ) {
            let e = Dr(u.keyframes, s);
            if (e !== void 0) {
              R.update(() => {
          ...
          return s.isSync ? new Nc(u) : new ml(u);
        }),
      (Ku = wu.length),
      (qu = [...Cu].reverse()),
      (Ju = Cu.length),
      ...
      (Yu = class extends Q {
        ...
        updateAnimationControlsSubscription() {
          ...
          In(e) && (this.unmountControls = e.subscribe(this.node));
        }
        mount() {
      ...
      (Qu = { animation: { Feature: Yu }, exit: { Feature: Zu } }),
      ($u = (e) => (t) => Wl(t) && e(t, Hr(t))),
      (ed = 1e-4),
      (td = 1 - ed),
      (nd = 1 + ed),
      ...
      (id = 0 - rd),
      (ad = 0 + rd),
      (od = () => ({ translate: 0, scale: 1, origin: 0, originPoint: 0 })),
      (sd = () => ({ x: od(), y: od() })),
      (cd = () => ({ min: 0, max: 0 })),
      ($ = () => ({ x: cd(), y: cd() })),
      (ld = (e, t) => Math.abs(e - t)),
      (ud = (e, t) => e.depth - t.depth),
      (dd = class {
        constructor() {
      ...
      (gd = class {
        ...
        constructor(
          ...
          (this.latestValues = s),
            ...
            (this.isControllingVariants = Rn(t)),
            (this.isVariantNode = zn(t)),
        ...
        bindToMotionValue(e, t) {
          ...
          let r = t.on(`change`, (t) => {
            ...
            a;
          S.MotionCheckAppearSync && (a = S.MotionCheckAppearSync(this, e, t)),
        ...
        getBaseTarget(e) {
          ...
          if (typeof n == `string` || typeof n == `object`) {
            let i = nr(this.props, n, (t = this.presenceContext)?.custom);
            i && (r = i[e]);
          }
        ...
        on(e, t) {
          return (
            this.events[e] || (this.events[e] = new fs()), this.events[e].add(t)
          );
        }
        notify(e, ...t) {
      ...
      (_d = 0.999999999999),
      (vd = 1.0000000000001),
      (yd = ({ current: e }) => (e ? e.ownerDocument.defaultView : null)),
      (bd = class {
        constructor(
          e,
          t,
          ...
          if (
            ...
            (this.updatePoint = () => {
              ...
              let e = Si(this.lastMoveEventInfo, this.history),
            ...
            (this.handlePointerMove = (e, t) => {
              (this.lastMoveEvent = e),
                (this.lastMoveEventInfo = bi(t, this.transformPagePoint)),
          ...
          let a = Hr(e),
            o = bi(a, this.transformPagePoint),
            { point: s } = o,
            { timestamp: c } = B;
          this.history = [{ ...s, timestamp: c }];
          let { onSessionStart: l } = t;
          l && l(e, Si(o, this.history)),
      ...
      (Cd = class {
        ...
        start(e, { snapToCursor: t = !1 } = {}) {
          ...
          let r = (e) => {
              ...
              n ? this.pauseAnimation() : this.stopAnimation(),
                t && this.snapToCursor(Hr(e).point);
            },
            i = (e, t) => {
              let {
                drag: n,
              ...
              (this.isDragging = !0),
                ...
                Tr(this.visualElement, `transform`);
            ...
            s = () =>
              k((e) => {
                ...
                return (
                  ...
                  (t = this.getAxisMotionValue(e).animation)?.play()
                );
              }),
            { dragSnapToOrigin: c } = this.getProps();
          this.panSession = new bd(
            e,
            {
              onSessionStart: r,
              onStart: i,
        ...
        updateAxis(e, t, n) {
          ...
          if (!n || !Ii(e, r, this.currentDirection)) return;
          let i = this.getAxisMotionValue(e),
            a = this.originPoint[e] + n[e];
          this.constraints &&
            this.constraints[e] &&
            (a = Ei(a, this.constraints[e], this.elastic[e])),
            i.set(a);
        }
        resolveConstraints() {
          var e;
          let { dragConstraints: t, dragElastic: n } = this.getProps(),
            r =
              ...
              !this.visualElement.projection.layout
                ...
                : (e = this.visualElement.projection)?.layout,
            i = this.constraints;
          t && Un(t)
            ? (this.constraints ||= this.resolveRefConstraints())
            : t && r
              ? (this.constraints = Oi(r.layoutBox, t))
              : (this.constraints = !1),
            (this.elastic = Ni(n)),
            i !== this.constraints &&
              r &&
        ...
        resolveRefConstraints() {
          ...
          let i = yi(n, r.root, this.visualElement.getTransformPagePoint()),
            a = Ai(r.layout.layoutBox, i);
          if (t) {
            let e = t(ri(a));
            (this.hasMutatedConstraints = !!e), e && (a = ni(e));
          }
          return a;
        }
        startAnimation(e) {
          let {
            ...
            s = this.constraints || {},
            c = k((o) => {
              if (!Ii(o, t, this.currentDirection)) return;
              let c = (s && s[o]) || {};
              a && (c = { min: 0, max: 0 });
              let l = r ? 200 : 1e6,
                u = r ? 40 : 1e7,
        ...
        startAxisValueAnimation(e, t) {
          ...
          return (
            Tr(this.visualElement, e),
            n.start(Gu(e, n, 0, t, this.visualElement, !1))
          );
        }
        stopAnimation() {
        ...
        pauseAnimation() {
          k((e) => {
            var t;
            return (t = this.getAxisMotionValue(e).animation)?.pause();
          });
        }
        getAnimationState(e) {
          var t;
          return (t = this.getAxisMotionValue(e).animation)?.state;
        }
        ...
        snapToCursor(e) {
          k((t) => {
            ...
            if (!Ii(t, n, this.currentDirection)) return;
            let { projection: r } = this.visualElement,
        ...
        scalePositionWithinConstraints() {
          ...
          if (!Un(t) || !n || !this.constraints) return;
          this.stopAnimation();
          let r = { x: 0, y: 0 };
          k((e) => {
            ...
            if (t && this.constraints !== !1) {
              let n = t.get();
              r[e] = ji({ min: n, max: n }, this.constraints[e]);
            }
          });
        ...
        addListeners() {
          ...
          r && !r.layout && (r.root && r.root.updateScroll(), r.updateLayout()),
            R.read(n);
          let a = Ur(S, `resize`, () => this.scalePositionWithinConstraints()),
      ...
      (Ed = class extends Q {
        ...
        onPointerDown(e) {
          this.session = new bd(e, this.createPanHandlers(), {
        ...
        mount() {
          this.removePointerDownListener = Wr(
            this.node.current,
            `pointerdown`,
      ...
      (Md = [`TopLeft`, `TopRight`, `BottomLeft`, `BottomRight`]),
      (Nd = Md.length),
      (Pd = (e) => (typeof e == `string` ? parseFloat(e) : e)),
      (Fd = (e) => typeof e == `number` || W.test(e)),
      (Id = Ui(0, 0.5, ws)),
      (Ld = Ui(0.5, 0.95, P)),
      (Rd = [`x`, `scaleX`, `originX`]),
      (zd = [`y`, `scaleY`, `originY`]),
      ...
      (Vd = { nodes: 0, calculatedTargetDeltas: 0, calculatedProjections: 0 }),
      (Hd = [``, `X`, `Y`, `Z`]),
      (Ud = { visibility: `hidden` }),
      (Wd = 1e3),
      (Gd = 0),
      (Kd = { duration: 0.45, ease: [0.4, 0, 0.1, 1] }),
      (qd = (e) =>
        p !== void 0 && p.userAgent && p.userAgent.toLowerCase().includes(e)),
      (Jd = qd(`applewebkit/`) && !qd(`chrome/`) ? Math.round : P),
      (Yd = sa({
      ...
      (Qd = {
        pan: { Feature: Ed },
        drag: { Feature: wd, ProjectionNode: Zd, MeasureLayout: zi },
      }),
      ($d = class extends Q {
        mount() {
          ...
          e &&
            (this.unmount = rn(
              e,
              (e, t) => (
                ka(this.node, t, `Start`), (e) => ka(this.node, e, `End`)
              ),
            ));
        }
        unmount() {}
        ...
        mount() {
          ...
          e &&
            (this.unmount = ln(
              e,
              (e, t) => (
                Aa(this.node, t, `Start`),
                (e, { success: t }) => Aa(this.node, e, t ? `End` : `Cancel`)
              ),
      ...
      (lf = class extends Q {
        ...
        startObserver() {
          ...
          return Ma(this.node.current, a, o);
        }
        mount() {
          this.startObserver();
        }
        update() {
          ...
          let { props: e, prevProps: t } = this.node,
            n = [`amount`, `margin`, `root`].some(Na(e, t));
      ...
      (df = { layout: { ProjectionNode: Zd, MeasureLayout: zi } }),
      (ff = class extends gd {
        constructor() {
      ...
      (pf = class extends ff {
        ...
        readValueFromInstance(e, t) {
          var n;
          if (Wc.has(t))
            return (n = this.projection)?.isProjecting ? Et(t) : Hc(e, t);
          {
            let n = Fa(e),
              r = (Bs(t) ? n.getPropertyValue(t) : n[t]) || 0;
      ...
      (hf = class extends ff {
        ...
        readValueFromInstance(e, t) {
          ...
          return (t = mf.has(t) ? t : yu(t)), e.getAttribute(t);
        }
        scrapeMotionValuesFromProps(e, t, n) {
          return vr(e, t, n);
        }
        ...
        mount(e) {
          (this.isSVGTag = Pu(e.tagName)), super.mount(e);
        }
      }),
      (gf = (e, t) =>
        hr(e) ? new hf(t) : new pf(t, { allowProjection: e !== C })),
      (_f = yr({ ...Qu, ...uf, ...Qd, ...df }, gf)),
      (vf = ar(_f)),
      (yf = { renderer: gf, ...Qu, ...uf }),
      (bf = { ...yf, ...Qd, ...df }),
      (xf = { renderer: gf, ...Qu }),
      (Sf = 50),
      (Cf = () => ({
      ...
      (jf = new WeakMap()),
      (Mf = new WeakMap()),
      (Nf = (e) => (e === document.scrollingElement ? S : e)),
      (Pf = new Map()),
      (Ff = () => ({
        scrollX: E(0),
        scrollY: E(0),
      ...
      (If = class extends zl {
        ...
        add(e) {
          (Wc.has(e) || Pl.has(e)) && ((this.isEnabled = !0), this.update());
        }
        update() {
      ...
      (Wf = { some: 0, all: 1 }),
      (Gf = () => ({})),
      (Kf = ku({ scrapeMotionValuesFromProps: Gf, createRenderState: Gf })),
      (qf = {}),
      de(qf, { Group: () => Yf, Item: () => Xf }),
      (Jf = T(null)),
      (Yf = i(Go)),
      (Xf = i(Yo));
  }),
...
export {
  su as AnimatePresence,
  fu as LayoutGroup,
  Fn as MotionConfig,
  Z as MotionConfigContext,
  N as MotionGlobalConfig,
  zl as MotionValue,
  rs as PresenceContext,
  Su as SwitchLayoutGroupContext,
  If as WillChangeMotionValue,
  ue as __commonJS,
  be as __decorateElement,
  ve as __decoratorMetadata,
  me as __decoratorStart,
  Te as __privateAdd,
  we as __privateGet,
  De as __privateMethod,
  Ee as __privateSet,
  xe as __publicField,
  ye as __runInitializers,
  pe as __toESM,
  Qn as addScaleCorrector,
  Hf as animate,
  wt as animateValue,
  z as cancelFrame,
  R as frame,
  Vo as inView,
  Zf as init_chunk_BLFSVU7M,
  Oe as init_chunk_YNHG2PI6,
  Qf as init_framer_motion_5EXT2AMG,
  gt as interpolate,
  Io as isMotionComponent,
  X as isMotionValue,
  Mn as isValidMotionProp,
  vf as motion,
  E as motionValue,
  xu as optimizedAppearDataAttribute,
  er as resolveMotionValue,
  Qa as scroll,
  pt as spring,
  Zo as stagger,
  bn as transform,
  ...
  Uf as useAnimation,
  Ho as useInView,
  Ro as useInstantLayoutTransition,
  Uo as useInstantTransition,
  to as useMotionValue,
  wn as usePresence,
  so as useReducedMotion,
  co as useReducedMotionConfig,
  Bo as useResetProjection,
  eo as useScroll,
  oo as useSpring,
  io as useTransform,
  fd as visualElementStore,
};
//# sourceMappingURL=motion.BvMEYU-E.mjs.map
